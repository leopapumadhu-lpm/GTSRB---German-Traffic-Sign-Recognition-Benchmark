...
if tab == "🏠 Dashboard":
    ...
    st.markdown('<p style="text-align: center; font-size: 1.2rem; color: #666; margin-bottom: 2rem;">Advanced AI-powered traffic sign recognition with multi-language voice support</p>', unsafe_allow_html=True)
    ...
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 3rem; border-radius: 20px; color: white; margin-bottom: 2rem;">
        <h2 style="color: white; text-align: center;">Welcome to German Traffic Sign AI</h2>
        <p style="text-align: center; font-size: 1.1rem; margin-top: 1rem;">
            The most advanced traffic sign recognition system with real voice speaking in 3 languages
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("""
        <div style="text-align: center; padding: 1.5rem; background: white; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); height: 220px; display: flex; flex-direction: column; justify-content: center;">
            <div style="font-size: 2.5rem; margin-bottom: 1rem;">🤖</div>
            <h4 style="margin: 0 0 0.5rem 0;">AI Recognition</h4>
            <p style="color: #666; font-size: 0.9rem; margin: 0;">Recognizes 43 German traffic signs with 98% accuracy</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div style="text-align: center; padding: 1.5rem; background: white; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); height: 220px; display: flex; flex-direction: column; justify-content: center;">
            <div style="font-size: 2.5rem; margin-bottom: 1rem;">🌐</div>
            <h4 style="margin: 0 0 0.5rem 0;">3 Languages</h4>
            <p style="color: #666; font-size: 0.9rem; margin: 0;">English, Hindi & Tamil language support</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div style="text-align: center; padding: 1.5rem; background: white; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); height: 220px; display: flex; flex-direction: column; justify-content: center;">
            <div style="font-size: 2.5rem; margin-bottom: 1rem;">🎵</div>
            <h4 style="margin: 0 0 0.5rem 0;">Voice Speaking</h4>
            <p style="color: #666; font-size: 0.9rem; margin: 0;">Hear predictions in selected language</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col4:
        ...
        <div style="text-align: center; padding: 1.5rem; background: white; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); height: 220px; display: flex; flex-direction: column; justify-content: center;">
            ...
            <p style="color: #666; font-size: 0.9rem; margin: 0;">Detailed charts & performance metrics</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with steps_col1:
        ...
        <div style="text-align: center; padding: 1.5rem;">
            <div style="background: #4ECDC4; color: white; width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem; font-size: 1.5rem; font-weight: bold;">1</div>
            <h4 style="margin: 0 0 0.5rem 0;">Go to Predict Tab</h4>
            <p style="color: #666;">Navigate to the "📤 Predict" tab from the sidebar</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with steps_col2:
        st.markdown("""
        <div style="text-align: center; padding: 1.5rem;">
            <div style="background: #FF6B6B; color: white; width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem; font-size: 1.5rem; font-weight: bold;">2</div>
            <h4 style="margin: 0 0 0.5rem 0;">Upload Image</h4>
            <p style="color: #666;">Upload a clear image of a German traffic sign</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with steps_col3:
        ...
        <div style="text-align: center; padding: 1.5rem;">
            ...
            <h4 style="margin: 0 0 0.5rem 0;">Get Results</h4>
            <p style="color: #666;">View predictions, hear voice, and see analytics</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with stats_col1:
        st.markdown("""
        <div style="text-align: center; padding: 1.5rem; background: linear-gradient(135deg, #00C9FF 0%, #92FE9D 100%); border-radius: 15px; color: white;">
            <h2 style="color: white; margin: 0; font-size: 2.5rem;">43</h2>
            <p style="margin: 0; font-size: 1rem;">Traffic Sign Classes</p>
        </div>
        """, unsafe_allow_html=True)
    
    with stats_col2:
        st.markdown("""
        <div style="text-align: center; padding: 1.5rem; background: linear-gradient(135deg, #FF6B6B 0%, #FF8E53 100%); border-radius: 15px; color: white;">
            <h2 style="color: white; margin: 0; font-size: 2.5rem;">98%</h2>
            <p style="margin: 0; font-size: 1rem;">Accuracy Rate</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with stats_col3:
        ...
        <div style="text-align: center; padding: 1.5rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 15px; color: white;">
            <h2 style="color: white; margin: 0; font-size: 2.5rem;">3</h2>
            <p style="margin: 0; font-size: 1rem;">Languages</p>
        </div>
        """, unsafe_allow_html=True)
    
    with stats_col4:
        st.markdown("""
        <div style="text-align: center; padding: 1.5rem; background: linear-gradient(135deg, #F7971E 0%, #FFD200 100%); border-radius: 15px; color: white;">
            <h2 style="color: white; margin: 0; font-size: 2.5rem;">0.2s</h2>
            <p style="margin: 0; font-size: 1rem;">Inference Speed</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_start2:
        ...
        <div style="text-align: center; padding: 2rem; background: #f8f9fa; border-radius: 15px; margin: 1rem 0;">
            <h3 style="color: #2c3e50; margin-bottom: 1rem;">Ready to try it out?</h3>
            <p style="color: #666; margin-bottom: 1.5rem;">Navigate to the <strong>📤 Predict</strong> tab in the sidebar to begin!</p>
            <div style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 12px 30px; border-radius: 30px; color: white; font-weight: bold; font-size: 1.1rem;">
                Go to Predict Tab →
            </div>
        </div>
        """, unsafe_allow_html=True)
    
    # What you can recognize section
    st.markdown("## 🚦 What You Can Recognize")
    ...
    with categories_col1:
        ...
        <div style="background: white; padding: 1.5rem; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
            <h4 style="color: #FF6B6B; margin-bottom: 1rem;">🚫 Speed Limits</h4>
            <ul style="color: #666; padding-left: 1.2rem;">
                <li>20, 30, 50, 60 km/h</li>
                <li>70, 80, 100, 120 km/h</li>
                <li>End of speed limits</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    ...
    with categories_col2:
        st.markdown("""
        <div style="background: white; padding: 1.5rem; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
            <h4 style="color: #4ECDC4; margin-bottom: 1rem;">⚠️ Warning Signs</h4>
            <ul style="color: #666; padding-left: 1.2rem;">
                <li>Curves & turns</li>
    ...
    with categories_col3:
        st.markdown("""
        <div style="background: white; padding: 1.5rem; border-radius: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
            <h4 style="color: #667eea; margin-bottom: 1rem;">🔵 Mandatory Signs</h4>
            <ul style="color: #666; padding-left: 1.2rem;">
                <li>Direction arrows</li>
                <li>Roundabout</li>
                <li>Keep right/left</li>
                <li>Priority signs</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    
    # Voice feature highlight
    st.markdown("## 🔊 Voice Feature Highlight")
    
    st.markdown("""
    <div style="background: linear-gradient(135deg, #FF6B6B 0%, #FF8E53 100%); padding: 2rem; border-radius: 15px; color: white; margin: 1rem 0;">
        <div style="display: flex; align-items: center; gap: 2rem;">
            <div style="font-size: 4rem;">🎵</div>
            <div>
                <h3 style="color: white; margin: 0 0 1rem 0;">Hear Predictions in 3 Languages!</h3>
                <p style="color: white; margin: 0; font-size: 1.1rem;">
                    Our system speaks predictions in English, Hindi, and Tamil. 
                    Just generate the voice and click play to hear it directly in the app!
                </p>
            </div>
        </div>
    </div>
